...
import net.mcreator.thelotrmod.entity.OrcEntity;
import net.mcreator.thelotrmod.entity.NazgulEntity;
import net.mcreator.thelotrmod.TheLotrModMod;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class TheLotrModModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, TheLotrModMod.MODID);
