...
public class TheLotrModModSounds {
	...
	public static final RegistryObject<SoundEvent> EVENSTAR = REGISTRY.register("evenstar", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("the_lotr_mod", "evenstar")));
}
