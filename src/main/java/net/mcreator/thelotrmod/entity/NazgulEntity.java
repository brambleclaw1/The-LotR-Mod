...
public class NazgulEntity extends Monster {
	public NazgulEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheLotrModModEntities.NAZGUL.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TheLotrModModItems.NINE_RINGS.get()));
	}

	@Override
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("the_lotr_mod:nazgul"));
	}
	...
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("the_lotr_mod:nazgul_dead"));
	}
