package net.mcreator.thelotrmod.world.features;
...
import net.mcreator.thelotrmod.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, TheLotrModMod.MODID);
