package net.mcreator.thehobbitmod;
...
import net.mcreator.thehobbitmod.init.TheHobbitModModMenus;
...
@Mod("the_hobbit_mod")
public class TheHobbitModMod {
	public static final Logger LOGGER = LogManager.getLogger(TheHobbitModMod.class);
	public static final String MODID = "the_hobbit_mod";

	public TheHobbitModMod() {
		...
		TheHobbitModModMenus.REGISTRY.register(bus);
